      ...
      <div className="mx-auto grid max-w-6xl grid-cols-1 md:grid-cols-5 gap-0 md:gap-8 px-4 md:px-6 py-8 md:py-12">
        ...
        <section className="md:col-span-2">
          <div className="h-full rounded-2xl border border-border bg-card shadow-sm p-6 md:p-8">
            <h2 className="text-2xl font-bold">Join AgriGoo Today</h2>
            ...
            <form className="mt-6 space-y-4" onSubmit={handleSubmit(onSubmit)} noValidate>
              ...
              <div>
                ...
                <Input
                  ...
                  type="email"
                  autoComplete="email"
                  placeholder="farmer@agrigoo.com"
              ...
              <div>
                ...
                {errors.confirmPassword && (
                  <p id="confirmPassword-error" className="mt-1 text-xs text-destructive">
